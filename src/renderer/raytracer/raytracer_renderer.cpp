...
void cg::renderer::ray_tracing_renderer::init()
{
	...
	lights.push_back({float3{-0.24f, 1.87f, 0.16f},
					  float3{0.78f, 0.78f, 0.78f} / 4.f});
	lights.push_back({float3{-0.24f, 1.87f, -0.22f},
					  float3{0.78f, 0.78f, 0.78f} / 4.f});
	lights.push_back({float3{0.23f, 1.87f, -0.22f},
					  float3{0.78f, 0.78f, 0.78f} / 4.f});
	lights.push_back({float3{0.23f, 1.87f, 0.16f},
					  float3{0.78f, 0.78f, 0.78f} / 4.f});
